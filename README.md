...
## 🎓 Sobre Mim  
Sou **Mestre em Engenharia de Software (2022)** pela **[Universidade Tecnológica Federal do Paraná (UTFPR)](https://www.utfpr.edu.br)**, com graduação em **Engenharia da Computação (2004)** pela **[UNOPAR](https://www.unopar.com.br)** e pós-graduação em **Redes de Computadores e Comunicação de Dados (2007)** pela **[UEL](https://www.uel.br)**.  

🔧 **Atuação Profissional:**  
- **Docência** em áreas como **Ciência da Computação**, **Engenharia de Software** e **Análise e Desenvolvimento de Sistemas**.  
- **Experiência técnica** em projetos de **Redes de Computadores** e **Comunicação de Dados**.  

---

## 🛠️ Habilidades e Interesses  
- **Engenharia de Software**: Arquitetura de sistemas, metodologias ágeis e qualidade de software.  
- **Redes e Infraestrutura**: Projetos de redes, segurança e otimização de comunicação.  
- **Educação Tecnológica**: Desenvolvimento de materiais didáticos e mentoria para formação de novos talentos.  
- **Inovação**: Pesquisa aplicada em tecnologias emergentes e soluções disruptivas.  

---

## 🌱 Projetos e Contribuições  
- **Repositórios Acadêmicos**: Compartilho materiais de ensino, projetos de pesquisa e tutoriais práticos.  
- **Open Source**: Contribuo para iniciativas que promovem educação tecnológica acessível.  
- **Colaborações**: Sempre aberto a parcerias em projetos inovadores! *(Sinta-se à vontade para entrar em contato!)*  
